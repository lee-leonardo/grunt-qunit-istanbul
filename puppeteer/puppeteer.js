...
const pageName = path.parse(targetURL).base;
...
(async () => {
  ...
  // TODO this is really great, but this is
...
//   });
  ...
  await page.exposeFunction('harness_begin', context => {
    console.log(`\nRunning: ${pageName}`);
  });
  ...
  await page.evaluate(() => {
    ...
    // Qunit.begin(context => { window.harness_begin(context); });
